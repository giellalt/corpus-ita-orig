...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://jll.se/download/18.420a58c9144917fddc910fb/1394722461165/Obsskylt+avlång+kondom+resa+Italienska.pdf'"/>
    ...
    <!-- Automatically filled in by CorpusTools -->
    <xsl:variable name="mainlang" select="'ita'"/>
    ...
    <language xml:lang="ita"/><language xml:lang="swe"/></xsl:variable>
